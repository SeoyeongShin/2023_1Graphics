...
# 4. 시스템 사용 방법 
### 시스템에서 사용 가능한 모델
SketchRNN은 디지털 라인 드로잉의 입력에서 이미지를 생성하기 위해 114개의 사전 훈련된 모델에 대한 액세스를 제공합니다. 
때문에 아래 링크에서 볼 수 있는 사전 훈련된 모델에 의해 모델을 입력 및 로드할 수 있습니다. 
[models.js] https://github.com/ml5js/ml5-library/blob/main/src/SketchRNN/models.js
